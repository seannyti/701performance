    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phone = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    SubscribeNewsletter = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP(6)"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP(6)"),
                    ...
                    EmailVerificationToken = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerPhone = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ServiceType = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrackingNumber = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ShippingCarrier = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AltText = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Caption = table.Column<string>(type: "varchar(1000)", maxLength: 1000, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "General", new DateTime(2026, 3, 16, 0, 47, 56, 613, DateTimeKind.Utc).AddTicks(2448), "The main company name displayed throughout the website", "Company Name", true, true, "site_name", null, 1, 0, new DateTime(2026, 3, 16, 0, 47, 56, 613, DateTimeKind.Utc).AddTicks(2448), "701 Performance Power" },
                    { 2, "General", new DateTime(2026, 3, 16, 0, 47, 56, 613, DateTimeKind.Utc).AddTicks(2451), "Brief tagline or motto displayed in headers and hero sections", "Company Tagline", true, false, "site_tagline", null, 2, 0, new DateTime(2026, 3, 16, 0, 47, 56, 613, DateTimeKind.Utc).AddTicks(2451), "" },
                    { 3, "General", new DateTime(2026, 3, 16, 0, 47, 56, 613, DateTimeKind.Utc).AddTicks(2453), "Main contact email address", "Contact Email", true, true, "contact_email", null, 3, 3, new DateTime(2026, 3, 16, 0, 47, 56, 613, DateTimeKind.Utc).AddTicks(2453), "info@701performancepower.com" },
                    { 4, "General", new DateTime(2026, 3, 16, 0, 47, 56, 613, DateTimeKind.Utc).AddTicks(2455), "Primary phone number for customer contact", "Contact Phone", true, false, "contact_phone", null, 4, 4, new DateTime(2026, 3, 16, 0, 47, 56, 613, DateTimeKind.Utc).AddTicks(2455), "" },
                    { 5, "General", new DateTime(2026, 3, 16, 0, 47, 56, 613, DateTimeKind.Utc).AddTicks(2457), "Physical business address", "Business Address", true, false, "contact_address", null, 5, 1, new DateTime(2026, 3, 16, 0, 47, 56, 613, DateTimeKind.Utc).AddTicks(2457), "" },
                    { 6, "General", new DateTime(2026, 3, 16, 0, 47, 56, 613, DateTimeKind.Utc).AddTicks(2459), "Main heading on the homepage hero section", "Homepage Hero Title", true, false, "hero_title", null, 6, 0, new DateTime(2026, 3, 16, 0, 47, 56, 613, DateTimeKind.Utc).AddTicks(2459), "" },
                    { 7, "General", new DateTime(2026, 3, 16, 0, 47, 56, 613, DateTimeKind.Utc).AddTicks(2461), "Subtitle text below the hero title", "Homepage Hero Subtitle", true, false, "hero_subtitle", null, 7, 1, new DateTime(2026, 3, 16, 0, 47, 56, 613, DateTimeKind.Utc).AddTicks(2461), "" },
                    { 8, "Security", new DateTime(2026, 3, 16, 0, 47, 56, 613, DateTimeKind.Utc).AddTicks(2463), "Whether new users can register on the site", "Allow User Registration", true, false, "allow_user_registration", null, 1, 7, new DateTime(2026, 3, 16, 0, 47, 56, 613, DateTimeKind.Utc).AddTicks(2463), "true" }
                });
